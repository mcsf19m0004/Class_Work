...
class TicTacToeBoard extends View {
    ...
    protected void onMeasure(int width,int height)
    {
        ...
        int dimentions=Math.min(getMeasuredWidth(),getMeasuredHeight());
        cellSize=dimentions/3;
        setMeasuredDimension(dimentions,dimentions);
    ...
    private void drawVerticalLine(Canvas canvas,int row,int col)
    {
        canvas.drawLine(col*cellSize+(float)cellSize/2, row,
                cellSize*col+(float)cellSize/2,cellSize*3,
                paint);
    }
